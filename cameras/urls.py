...
from .views import CameraCreateView, CameraDetailView, CameraHistoryView, CameraListView, CameraStatusView
...
urlpatterns = [
    ...
    path("<str:device_id>/history/", CameraHistoryView.as_view(), name="api-cameras-history"),
